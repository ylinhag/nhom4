...
{
    public class CRUDTheLoaiController : Controller
    {
        private readonly TinTucContext _context;

        public CRUDTheLoaiController(TinTucContext context)
        {
            _context = context;
        }
        ...
        // GET: CRUDTheLoai/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: CRUDTheLoai/Create
